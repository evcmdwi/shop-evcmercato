    ...
    <tr><td align="center">
      <table width="600" cellpadding="0" cellspacing="0" style="background-color: #ffffff; border-radius: 8px; overflow: hidden; max-width: 600px; width: 100%;">
        ...
        <tr><td style="padding: 32px 24px;">
          ...
          <!-- Items -->
          <h3 style="color: #333; border-bottom: 2px solid #7FB300; padding-bottom: 8px;">🛒 Detail Pesanan</h3>
          <table width="100%" cellpadding="0" cellspacing="0">
            ...
            <tr style="border-top: 2px solid #333;">
              ...
              <td style="padding: 12px 0; text-align: right; font-weight: bold; font-size: 16px; color: #7FB300;">${formatRupiah(payload.totalAmount)}</td>
            </tr>
          </table>

          <!-- Shipping -->
          <h3 style="color: #333; border-bottom: 2px solid #7FB300; padding-bottom: 8px; margin-top: 24px;">📦 Alamat Pengiriman</h3>
          ...
          <div style="text-align: center; margin: 24px 0;">
            <a href="https://shop.evcmercato.com/orders/${payload.orderId}" style="background-color: #7FB300; color: #ffffff; padding: 12px 32px; border-radius: 6px; text-decoration: none; font-weight: bold; display: inline-block;">Lihat Status Pesanan</a>
          </div>
        </td></tr>
