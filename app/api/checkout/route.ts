...
export async function POST(req: NextRequest) {
  try {
    ...
    // Affiliate attribution — simpan kode saja di checkout, commission dibuat saat ORDER PAID (webhook)
    try {
      ...
      if (attribution.code) {
        ...
        console.log('[affiliate] order', order.id, 'attributed to', attribution.code, '— commission pending payment')
      }
