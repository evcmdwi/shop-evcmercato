...
function RedeemForm({ id }: { id: string }) {
  ...
  const totalFee = config.shipping_cost + config.admin_fee
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div className="bg-white rounded-2xl p-5 shadow-sm border border-gray-100">
            ...
            <div className="space-y-2 text-sm">
              ...
              <div className="flex justify-between"><span className="text-gray-600">Ongkos kirim</span><span>{formatRupiah(config.shipping_cost)}</span></div>
              <div className="flex justify-between"><span className="text-gray-600">Biaya admin</span><span>{formatRupiah(config.admin_fee)}</span></div>
